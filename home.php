...
<body>
    <div class="container-fluid w-100 d-flex flex-column p-0 mx-0">
        <!-- Navbar -->
        <div id="navbar" class="navbar navbar-expand-sm bg-primary-custom">
        ...
        <div class="content-container imaged-container px-0">
            <!-- Schedule -->
            <div class="row">
                <div class="content-container text-container text-center col-6 bg-primary-custom">
                    <h3 class="font-header text-header">Schedule</h3>
                    ...
                    <h4 class="font-header">Contact Us</h4>
                    <div class="row d-flex justify-content-center">
                        <p class="font-paragraph">021 111 222 333</p>
            ...
            <div class="row w-100 mx-0">
                <div class="col-6"></div>
                <div class="content-container text-container col-6 text-center bg-primary-custom">
                    <h3 class="font-header text-header">Location</h3>
                    <p></p>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d33859098.71777259!2d-12.328587300000013!3d-58.80400019999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xb09dff882a7809e1%3A0xb08d0a385dc8c7c7!2sAntarctica!5e0!3m2!1sen!2sid!4v1714896732989!5m2!1sen!2sid" width="450" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
